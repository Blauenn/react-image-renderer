		...
		<>
			<div className={section_styles}>
				<div className="flex flex-row gap-4">
					...
					<input onChange={(e) => fieldChanges(e, "facebook", setContactInfo)} id="facebook" type="text" className="px-2 border border-opacity-50 rounded-lg shadow-sm" />
				</div>
				<div className="flex flex-row gap-4">
					<label htmlFor="instagram" className="text-pink-500 text-md">Instagram:</label>
					<input onChange={(e) => fieldChanges(e, "instagram", setContactInfo)} id="instagram" type="text" className="px-2 border border-opacity-50 rounded-lg shadow-sm" />
				</div>
			</div>
			...
			<div className={`${section_styles} ${(contactInfo.facebook != "" || contactInfo.instagram != "") || "opacity-50"}`}>
				<div className="flex flex-row gap-4">
					...
					<input onChange={(e) => fieldChanges(e, "facebook_2", setContactInfo)} disabled={contactInfo.facebook == "" && contactInfo.instagram == ""} id="facebook_2" type="text" className="px-2 border border-opacity-50 rounded-lg shadow-sm" />
				</div>
				<div className="flex flex-row gap-4">
					<label htmlFor="instagram_2" className="text-pink-500 text-md">Instagram:</label>
					<input onChange={(e) => fieldChanges(e, "instagram_2", setContactInfo)} disabled={contactInfo.facebook == "" && contactInfo.instagram == ""} id="instagram_2" type="text" className="px-2 border border-opacity-50 rounded-lg shadow-sm" />
				</div>
			</div>
		</>
	);
