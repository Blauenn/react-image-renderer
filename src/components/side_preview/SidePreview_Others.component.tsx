	...
	return (
		<>
			...
			<div className={section_styles}>
				<div className="flex flex-col gap-4">
					<div className="flex flex-col gap-2">
						<label htmlFor="export_file_name" className="text-md">Export file name</label>
						<input onChange={(e) => fieldChanges(e, "file_name", setOtherInfo)} id="export_file_name" type="text" defaultValue="Rendered image" className="px-2 border border-opacity-50 rounded-lg shadow-sm" />
					</div>
				</div>
			</div>
		</>
